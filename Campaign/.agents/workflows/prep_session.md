...
1.  **Review the Target (SessionPlanner Mode):**
    Read `state.md` to determine the *Current Episode* and *Current Chapter*. Read the corresponding `03_Story/.../Encounter.md` files or previous session logs to understand the starting point. Identify where the PCs currently are and what unresolved plot threads exist.

2.  **Determine Session Goal:**
...
5.  **Flavor Generation (Narrator Mode):**
