...
2.  **Generate `00_System_Rules.md`:**
    Using the GM's answers, immediately draft the `00_System_Rules.md` file using the established template format. Include recommendations for forbidden advantages or required skills based on the genre.

3.  **Establish Initial Lore (WorldBuilder Mode):**
...
4.  **Ready confirmation:**
    Inform the GM that the campaign structure is initialized and they can now begin creating PCs or running the `prep_session` workflow.
