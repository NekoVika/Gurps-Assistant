...
from rulesdb_lib.commands.search import cmd_search as _cmd_search
from rulesdb_lib.commands.search import cmd_semantic_search as _cmd_semantic_search
...
SEARCH_DEPS = SearchCommandDeps(
    ...
    fetch_entity_rows_by_ids=_fetch_entity_rows_by_ids,
    fetch_chunk_rows_by_ids=_fetch_chunk_rows_by_ids,
)

ENTITY_EXTRACT_DEPS = EntityExtractCommandDeps(
    default_config_path=DEFAULT_CONFIG_PATH,
    default_db_path=DEFAULT_DB_PATH,
    rules_db_dir=RULES_DB_DIR,
    connect=_connect,
    ...
    pick_book_cfg=_pick_book_cfg,
    pick_book_id=_pick_book_id,
    maneuver_name_map=lambda: _maneuver_name_map(),
    combat_rule_name_map=lambda: _combat_rule_name_map(),
)
...
def cmd_search(args: argparse.Namespace) -> int:
    return _cmd_search(args, SEARCH_DEPS)


def cmd_chunk_show(args: argparse.Namespace) -> int:
    return _cmd_chunk_show(args, SEARCH_DEPS)
...
def cmd_entity_extract(args: argparse.Namespace) -> int:
    return _cmd_entity_extract(args, ENTITY_EXTRACT_DEPS)
...
def cmd_semantic_search(args: argparse.Namespace) -> int:
    return _cmd_semantic_search(args, SEARCH_DEPS)


def cmd_agent_search(args: argparse.Namespace) -> int:
    return _cmd_agent_search(args, SEARCH_DEPS)
